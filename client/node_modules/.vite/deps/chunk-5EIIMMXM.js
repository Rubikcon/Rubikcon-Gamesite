...
var ICONS = {
  add: async () => (await import("./add-YYOMBEXQ.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-6LQ3MDM6.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-6KZ5O3A7.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-E7WHZH2N.js")).appStoreSvg,
  apple: async () => (await import("./apple-PLQ6JFVF.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-V7BIOFEG.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-56OCQDMB.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-G6CUITME.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-2YJH3O6J.js")).arrowTopSvg,
  bank: async () => (await import("./bank-DITUXEGB.js")).bankSvg,
  browser: async () => (await import("./browser-OLUTVC7L.js")).browserSvg,
  card: async () => (await import("./card-GMG5ZWEF.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-LMQ3TRW3.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-ZMR7ZYN3.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-BEHCCZDL.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-UKTS7KYK.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-LOX3ZS4L.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-E6IZ5VSM.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-NK6XCQBD.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-KMFGYFCD.js")).clockSvg,
  close: async () => (await import("./close-TBTIHVQ2.js")).closeSvg,
  compass: async () => (await import("./compass-KMHCV72N.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-Q3NINNKN.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-K2M4BKG3.js")).copySvg,
  cursor: async () => (await import("./cursor-QGBFCHFL.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-DA62567Q.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-CLUO3OOE.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-BHOQF3NC.js")).disconnectSvg,
  discord: async () => (await import("./discord-XORXBJCN.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-M2AWAKHG.js")).etherscanSvg,
  extension: async () => (await import("./extension-FOXTRXSG.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-PFHT6WJN.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HKNQVO5Y.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-5Q7C2E55.js")).farcasterSvg,
  filters: async () => (await import("./filters-K4WTRBHD.js")).filtersSvg,
  github: async () => (await import("./github-5KNPC6X2.js")).githubSvg,
  google: async () => (await import("./google-T4CA6KWT.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-MHMY3OZZ.js")).helpCircleSvg,
  image: async () => (await import("./image-DN5OJYCY.js")).imageSvg,
  id: async () => (await import("./id-5FHGR55O.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-UR53NJ56.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-V45ZUFAM.js")).lightbulbSvg,
  mail: async () => (await import("./mail-4427WEEO.js")).mailSvg,
  mobile: async () => (await import("./mobile-ML5CAOMC.js")).mobileSvg,
  more: async () => (await import("./more-YTUOQBHA.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-CJLRE3ZQ.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-JOYTODST.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-63XHH3HF.js")).offSvg,
  playStore: async () => (await import("./play-store-L4YRHT3D.js")).playStoreSvg,
  plus: async () => (await import("./plus-2OWASAZI.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-O7FPSDSY.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-FNDNISXB.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-WM3MDZTX.js")).refreshSvg,
  search: async () => (await import("./search-IZGHYNSY.js")).searchSvg,
  send: async () => (await import("./send-RACVKCNM.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-QKVX5VYX.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-22AV7LSW.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-JK3UI4QQ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-6GL3BSJZ.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-7TJ6ZSZC.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-3SQSR7KK.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-4M5OSM6K.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-W7OMWT2E.js")).twitchSvg,
  twitter: async () => (await import("./x-HHNU6RLB.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-JRXE3WY4.js")).twitterIconSvg,
  verify: async () => (await import("./verify-3JYD7MPP.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-2IYRPMOZ.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-CUOSWZHY.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-ZM7VELKB.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-ZM7VELKB.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-ZM7VELKB.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-ON5MMNTZ.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-5PVILUGY.js")).warningCircleSvg,
  x: async () => (await import("./x-HHNU6RLB.js")).xSvg,
  info: async () => (await import("./info-JHRXA5MG.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-KOLGBRRI.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-HCKJW4PM.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5EIIMMXM.js.map
