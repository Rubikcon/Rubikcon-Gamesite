...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-NBTDVH75.js";
import "./chunk-HDCGRSTT.js";
import {
  BaseError,
  ...
  validate,
  validate2
} from "./chunk-VGTQVDMR.js";
import "./chunk-6PAXDA74.js";
import {
  mainnet
} from "./chunk-UFMBX5CD.js";
import "./chunk-5CABNN7M.js";
import "./chunk-J2YC6325.js";
import {
  ...
  isAddress,
  numberToHex
} from "./chunk-PNDNNJ7Z.js";
import {
  formatAbi,
  formatAbiItem,
  parseAbi
} from "./chunk-O6T7JZTT.js";
import "./chunk-436IFJNS.js";
import "./chunk-EI24TEBN.js";
import {
  useQuery
} from "./chunk-T6TH2BYN.js";
import {
  clsx_default
...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-TD3LSJ6R.js";
import {
  __assign,
  __rest,
  __spreadArray,
  init_tslib_es6
} from "./chunk-EK6UDENO.js";
import {
  require_react_dom
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-NQJE4CIA.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-RSTS3VPV.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-NSLAOB6B.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-XNZFADFN.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-FEP55T4S.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-SHRVG3GT.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-CTNWGWSS-FLV4IDPI.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-P43L3PR7-A6XB6EG2.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-RFN65H63-TZHQMAJB.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-JBX5FS3Q-MYGMUM2H.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-CM2EDAQC-IBQOQ7RD.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-GYVCUYRD-QY2KKMHK.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-7ZWSMOOE-WRCSDABZ.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-CGMP6VLZ-T27HZUZT.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-YCZDTF7X-IEOCVWLI.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-5LHAYMS7-7URJCSGM.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-3JTS4PSK-EKWMX5AH.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-6J6XERHI-JYARQVDG.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-STXOD4CR-AA6FILYV.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-P7QAUUZU-YWNQVKOL.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-JTTBGJGQ-MWQFXUVZ.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-5XUUAVWW-AXHXC7CH.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-RGMLPFEP-N5IOKKEI.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-YM3T6EI5-BKDBE3B2.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-HAEH6VE5-LJ7QCIFH.js")).default;
    default:
      return (await import("./en_US-RFN65H63-TZHQMAJB.js")).default;
  }
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-SX5YFU6N-VTYW3JXM.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-WURIBY6W-TSC5FEUY.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-KOMJD3XY-IBAUZ7X2.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-OAXLRA4F-YY56COVA.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-NJECWIVC-RE5J2N4O.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-V555OVXZ-23MK4NKI.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-N647EYR2-T5I5BNOJ.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-GEP4TUHG-EMGHVOIM.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-HJPAQTAE-BEPPLZGC.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-FQQ4XGHB-LDANXNVM.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RGGVA4PY-UKZ4NUEB.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-5FQJFCTK-WRMACVXN.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-37ZC4RBL-5SQWYTT5.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-J5YQHTYH-7I37TSNW.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-TX56IT5N-GKPVAHSY.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-VKPAA4SA-KN5H4UMA.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-FZMYZWHG-JJ4NRYHP.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-65D2U3PU-A3WQKEVG.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-QRMVQ5DY-QFJWEOHX.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-SI27YFEJ-FID7P4AP.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-CKIUT334-EGUXALRI.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-HAF2GUT7-P3QNTMBL.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WW6ZI7PM-L6QTNIVF.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-EMCPYXZT-DU2TUNXZ.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./sanko-RHQYXGM5-EAYXZWVV.js")).default
};
var superpositionIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./superposition-HG6MMR2Y-37O73RUT.js")).default
};
var scrollIcon = {
  iconBackground: "#FFEEDA",
  iconUrl: async () => (await import("./scroll-5OBGQVOV-GUBR4BFS.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-C5BWO2ZY-5PG4OX5S.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-KJ3TDBYO-E6NTS656.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-TLDS5IPW-KB24V4CU.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-DH7HK5U4-JIZ3JNMM.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-FYL5H3IO-6IZNGZLT.js")).default
};
...
var src = async () => (await import("./assets-Q6ZU7ZJ5-LKGWQVM7.js")).default;
...
var src2 = async () => (await import("./login-UP3DZBGS-VTSTYCAQ.js")).default;
...
var signInIcon = async () => (await import("./sign-A7IJEUT5-OZ4RDZIP.js")).default;
function SignIn({
  onClose,
  onCloseModal
}) {
...
var src3 = async () => (await import("./connect-UA7M4XW6-I4LADXWY.js")).default;
...
var src4 = async () => (await import("./create-FASO7PVG-FZNYD6PU.js")).default;
...
var src5 = async () => (await import("./refresh-S4T5V5GX-TZXOQMOL.js")).default;
...
var src6 = async () => (await import("./scan-4UYSQ56Q-UDEXO3E2.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-VDBY7LNS-PONCT7KS.js")).default;
    case "Brave":
      return (await import("./Brave-BRAKJXDS-7U5LH76T.js")).default;
    case "Chrome":
      return (await import("./Chrome-65Q5P54Y-TREXKHTZ.js")).default;
    case "Edge":
      return (await import("./Edge-XSPUTORV-WDDUQIFN.js")).default;
    case "Firefox":
      return (await import("./Firefox-AAHGJQIP-LWHU6APA.js")).default;
    case "Opera":
      return (await import("./Opera-KQZLSACL-ZZPXYX2T.js")).default;
    case "Safari":
      return (await import("./Safari-ZPL37GXR-2EXVSQQM.js")).default;
    default:
      return (await import("./Browser-76IHF3Y2-5U3JGEX7.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-PPTHQER6-FSYWHBI5.js")).default;
    case "macOS":
      return (await import("./Macos-MW4AE7LN-OVFUXLOC.js")).default;
    case "Linux":
      return (await import("./Linux-OO4TNCLJ-TET6TUEE.js")).default;
    default:
      return (await import("./Linux-OO4TNCLJ-TET6TUEE.js")).default;
  }
};
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    shortName: "Coinbase",
    rdns: "com.coinbase.wallet",
    iconUrl: async () => (await import("./coinbaseWallet-OKXU3TRC-RMATJQO6.js")).default,
    iconAccent: "#2c5ff6",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-SITXT2FV-T2XYS5MD.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-O26YNBMX-K3Y3DWFD.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-5MNKTR5Z-7XUZ7BVV.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-YHWKVTDY-36ZNDYUE.js")).default,
