import {
  ...
  withTimeout,
  writeContract
} from "./chunk-NDP2FULQ.js";
import {
  require_jsx_runtime
} from "./chunk-YAL2NXYN.js";
import {
  require_react
} from "./chunk-SSYDPZYZ.js";
import {
...
var BaseError = class _BaseError extends Error {
  ...
  constructor(shortMessage, options = {}) {
    ...
    const details = options.cause instanceof _BaseError ? options.cause.details : ((_a5 = options.cause) == null ? void 0 : _a5.message) ? options.cause.message : options.details;
...
async function connect(config, parameters) {
  ...
  try {
    ...
    await ((_a5 = config.storage) == null ? void 0 : _a5.setItem("recentConnectorId", connector.id));
    config.setState((x) => ({
      ...x,
...
async function disconnect(config, parameters = {}) {
  ...
  });
  {
    ...
    if (!current)
      return;
    const connector2 = (_a5 = config.state.connections.get(current)) == null ? void 0 : _a5.connector;
    if (!connector2)
      return;
...
async function readContracts(config, parameters) {
  ...
  try {
    ...
    for (const [index2, contract] of contracts.entries()) {
      ...
      (_a5 = contractsByChainId[chainId]) == null ? void 0 : _a5.push({ contract, index: index2 });
    }
...
async function reconnect(config, parameters = {}) {
  ...
  const connectors = [];
  if ((_a5 = parameters.connectors) == null ? void 0 : _a5.length) {
...
async function switchChain2(config, parameters) {
  ...
  const connection = config.state.connections.get(((_a5 = parameters.connector) == null ? void 0 : _a5.uid) ?? config.state.current);
  if (connection) {
    const connector = connection.connector;
...
function injected(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async connect({ chainId, isReconnecting: isReconnecting2 } = {}) {
      ...
      if (isReconnecting2)
        ...
        try {
          ...
          accounts = (_d = (_c = (_b = (_a5 = permissions[0]) == null ? void 0 : _a5.caveats) == null ? void 0 : _b[0]) == null ? void 0 : _c.value) == null ? void 0 : _d.map((x) => getAddress(x));
    ...
    async disconnect() {
      ...
      if (shimDisconnect) {
        await ((_a5 = config.storage) == null ? void 0 : _a5.setItem(`${this.id}.disconnected`, true));
      }
      if (!parameters.target)
    ...
    async isAuthorized() {
      ...
      try {
        ...
        await ((_a5 = config.storage) == null ? void 0 : _a5.getItem(`${this.id}.disconnected`));
        if (isDisconnected)
          return false;
        if (!parameters.target) {
    ...
    async switchChain({ addEthereumChainParameter, chainId }) {
      ...
      try {
        ...
        ((_b = (_a5 = error == null ? void 0 : error.data) == null ? void 0 : _a5.originalError) == null ? void 0 : _b.code) === 4902) {
          try {
    ...
    async onAccountsChanged(accounts) {
      ...
      if (accounts.length === 0)
        ...
        if (shimDisconnect)
          await ((_a5 = config.storage) == null ? void 0 : _a5.removeItem(`${this.id}.disconnected`));
      } else
...
var targetMap = {
  ...
  phantom: {
    ...
    provider(window2) {
      var _a5, _b;
      if ((_a5 = window2 == null ? void 0 : window2.phantom) == null ? void 0 : _a5.ethereum)
...
var persistImpl = (config, baseOptions) => (set, get, api) => {
  ...
  const hydrate3 = () => {
    ...
    const postRehydrationCallback = ((_b = options.onRehydrateStorage) == null ? void 0 : _b.call(options, (_a5 = get()) != null ? _a5 : configResult)) || void 0;
...
function createConfig(parameters) {
  ...
  function setup(connectorFn) {
    ...
    (_a5 = connector.setup) == null ? void 0 : _a5.call(connector);
    return connector;
  }
  ...
  if (syncConnectedChain)
    store.subscribe(({ connections, current }) => {
      var _a5;
      return current ? (_a5 = connections.get(current)) == null ? void 0 : _a5.chainId : void 0;
    }, (chainId) => {
      ...
      if (config._internal.ssr) {
        ...
        if (config._internal.mipd) {
          config._internal.connectors.setState((connectors) => {
            ...
            const providers = ((_a5 = config._internal.mipd) == null ? void 0 : _a5.getProviders()) ?? [];
            for (const provider of providers) {
              if (rdnsSet.has(provider.info.rdns))
                continue;
...
function cookieToInitialState(config, cookie) {
  ...
  if (!cookie)
    return void 0;
  const key = `${(_a5 = config.storage) == null ? void 0 : _a5.key}.store`;
...
function extractRpcUrls(parameters) {
  ...
  if (!parameters.transports)
    return [fallbackUrl];
  const transport = (_b = (_a5 = parameters.transports) == null ? void 0 : _a5[chain.id]) == null ? void 0 : _b.call(_a5, { chain });
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4RJJ5PK7.js.map
