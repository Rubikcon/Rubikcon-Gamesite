...
var ICONS = {
  add: async () => (await import("./add-BOCEC2TO.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-QMGNTXRE.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-2ZTRIVUH.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-QRTN7TJD.js")).appStoreSvg,
  apple: async () => (await import("./apple-4OTOXPFH.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-EX4HBV7J.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-CVBXR7FL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-ITGIFAQX.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-W6RQ5G2I.js")).arrowTopSvg,
  bank: async () => (await import("./bank-W7E4JY4O.js")).bankSvg,
  browser: async () => (await import("./browser-CTI4FT56.js")).browserSvg,
  card: async () => (await import("./card-YXQGQ4H2.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-7UW2INIJ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-ONRPPOYS.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-EAIIPGOU.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-EFPCALCQ.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-JLL2JTYC.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-IC25D6RT.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-TSPZQ2O5.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-3IR3X5AK.js")).clockSvg,
  close: async () => (await import("./close-2MRKFW4L.js")).closeSvg,
  compass: async () => (await import("./compass-66R6NBZG.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-6UAAJ6DK.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-W6KGK5XR.js")).copySvg,
  cursor: async () => (await import("./cursor-6BIB3UYR.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-OO3MTYBF.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-QLYFAHF5.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-EVDDS75V.js")).disconnectSvg,
  discord: async () => (await import("./discord-WUXYDPCJ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-3FQGE2Y3.js")).etherscanSvg,
  extension: async () => (await import("./extension-IJ4IURJU.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-QCXZ4IC5.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-MO4VV4Z4.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-BER2YBZT.js")).farcasterSvg,
  filters: async () => (await import("./filters-MGLHSKZO.js")).filtersSvg,
  github: async () => (await import("./github-2HC2ML5B.js")).githubSvg,
  google: async () => (await import("./google-ESWGLUGA.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-VBQNSGZX.js")).helpCircleSvg,
  image: async () => (await import("./image-SUAFZXLG.js")).imageSvg,
  id: async () => (await import("./id-DLYPS7EV.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-M4ATMDAP.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-KDLG2H5Y.js")).lightbulbSvg,
  mail: async () => (await import("./mail-THYWGBW6.js")).mailSvg,
  mobile: async () => (await import("./mobile-A4PTW6H3.js")).mobileSvg,
  more: async () => (await import("./more-VTSZTNRX.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-RUEGST4V.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-6HDTIGZR.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-CEA7U7W6.js")).offSvg,
  playStore: async () => (await import("./play-store-L22VT7RK.js")).playStoreSvg,
  plus: async () => (await import("./plus-4GNTBDMJ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-LZOZX243.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-HY2JVTNC.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-PGBOXEN5.js")).refreshSvg,
  search: async () => (await import("./search-IYXBAFTV.js")).searchSvg,
  send: async () => (await import("./send-M36AYYCR.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-JGT6AJ7K.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-BSTDISER.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-PNYS7LME.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-E2IICWQK.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-JS6N7DNN.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-3WT5OT7G.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-4YWUAELD.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-ETPN3WTN.js")).twitchSvg,
  twitter: async () => (await import("./x-QLVGIR6V.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-UVJJ4SSL.js")).twitterIconSvg,
  verify: async () => (await import("./verify-LL5PG5RI.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-NCOBM4DA.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-2TZIJBEE.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-5OV4466W.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-5OV4466W.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-5OV4466W.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-XMC2O5JZ.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-2K7U2NLS.js")).warningCircleSvg,
  x: async () => (await import("./x-QLVGIR6V.js")).xSvg,
  info: async () => (await import("./info-MULM4XID.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-LWKKQCIA.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-OJ3GCKZD.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SB2MK7PI.js.map
